...
Uses template from https://github.com/Spissable/advent-of-go-template

## How to use

1. Run `make init` to initialize empty `input.txt` files. The files are gitignored as per the AoC ToS.
